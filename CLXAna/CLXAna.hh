...
float		deadlayer = 0.0007;	        ///< CD dead layer (aluminium) thickness in mg/cm^2
...
bool		emit_outside_targ = false;	///< Flag to assume gamma emission outside target (on average), else prompt emission.
